...
export default function NewCourseCarousel(): JSX.Element {
    ...
    useEffect(() => {
        const fetchCourses = async () => {
            try {
                ...
                const response = await courseService.getNewestThisMonth(20);
                ...
                >
                    <Stack>
                        ...
                        <Typography color="neutral">
                            Discover the latest courses added this month
                        </Typography>
                    </Stack>
                    <Button
                    ...
                    >
                        See All New Courses This Month
                    </Button>
                </Stack>
                ...
                {isEmpty && (
                    ...
                    >
                        <div>
                            ...
                            >
                                There are no new courses available at the
                                moment.
                            </Typography>
                        </div>
                    </Alert>
