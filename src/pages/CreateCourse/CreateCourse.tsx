...
export default function CreateCourse(): JSX.Element {
    ...
    const [ingredients, setIngredients] = useState<CourseIngredient[]>([
    ...
    const handleSubmit = async () => {
        // Validate course name (not null or whitespace)
        if (!name || !name.trim()) {
        ...
        try {
            ...
            openSnackbar('Course created successfully!', 'success');
