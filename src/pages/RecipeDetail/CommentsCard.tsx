...
export function CommentsCard({
    ...
    // Sync comments when recipeComments prop changes
    useEffect(() => {
    ...
    const handleSubmit = async () => {
        ...
        if (!recipeId) {
            openSnackbar('Recipe ID is missing', 'danger');
            return;
        }
        ...
        try {
            ...
            // The API response may contain the created comment, but we'll use user data from context
            const newComment: RecipeComment = {
                recipeCommentId: Date.now(), // Temporary ID, will be replaced when refreshed
                comment: commentText.trim(),
                createdAt: new Date(),
                user: {
